...
def train_two_stage(poblem_, X_train, Y_train, X_test, Y_test, EPOCHS = 2710):
...
def train_task_loss(poblem_, X_train, Y_train, X_test, Y_test, two_stage_forecast, EPOCHS = 200):
    import copy 
